...
const moods: Mood[] = [
    ...
    },
    {
        ...
        prompt: "Write a thoughtful, empathetic social media caption for sad moments",
    },
    {
        id: "love",
        name: "Love",
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">
                                Uses advanced AI to generate creative and
                                engaging captions
                            </p>
                        </div>
                        <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">
                                Select from various moods to get perfectly
                                tailored captions
                            </p>
                        </div>
                        <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">
                                One-click copy and generate again for endless
                                inspiration
                            </p>
                        </div>
                    </div>
